      ...
      <div className="mb-8">
        ...
        <div className="flex items-center gap-3 mb-4">
          <div className="flex flex-1 gap-3">
            <button
              className={`px-4 py-2 cursor-pointer rounded-lg transition-all flex-1 text-center ${
                sortBy === "name"
      ...
      {sortBy !== "grouped" ? (
        ...
        <div className="space-y-6">
          {sortedCategories.map((category) => (
            <div
              key={category}
              className="bg-white/10 backdrop-blur-sm rounded-xl p-4 shadow-sm border border-white/20 shadow-mdS"
            >
